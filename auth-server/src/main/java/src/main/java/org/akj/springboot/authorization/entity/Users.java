...
public class Users {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(id, users.id) && Objects.equals(username, users.username)
				&& Objects.equals(nickname, users.nickname) && Objects.equals(password, users.password)
				&& Objects.equals(birthday, users.birthday) && Objects.equals(sex, users.sex)
				&& Objects.equals(avatar, users.avatar) && Objects.equals(mobile, users.mobile)
				&& Objects.equals(email, users.email) && Objects.equals(status, users.status)
				&& Objects.equals(lastSigninTime, users.lastSigninTime)
				&& Objects.equals(lastSignoutTime, users.lastSignoutTime) && Objects.equals(updateAt, users.updateAt)
				&& Objects.equals(createAt, users.createAt);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, username, nickname, password, birthday, sex, avatar, mobile, email, status,
				lastSigninTime, lastSignoutTime, updateAt, createAt);
	}
}